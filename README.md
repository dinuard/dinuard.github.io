    ...
    <section class="py-16 px-6 max-w-6xl mx-auto">
        ...
        <div class="p-6 bg-slate-900/50 rounded-xl border border-teal-500/30 hover:border-teal-500/60 transition">
                ...
                <div class="flex items-center justify-between">
                    <h3 class="font-bold text-white text-base">Co-Pilot Award</h3>
                    <span class="text-[10px] px-2 py-0.5 bg-teal-500/10 text-teal-400 font-semibold rounded border border-teal-500/20">FY26 Q2</span>
                </div>
                <p class="text-xs text-slate-400 mt-2">Outstanding contribution and embodying the AI Reinventor's mindset.</p>
            </div>
                ...
                <div class="lg:col-span-1 bg-slate-900 p-6 rounded-xl border border-slate-800 flex flex-col justify-between">
                    <div>
                        <div class="flex items-center justify-between mb-4">
                            <span class="px-3 py-1 bg-teal-500/10 text-teal-400 text-xs font-semibold rounded-full border border-teal-500/20">Bachelor's Degree (Hons.)</span>
                            <i class="fa-solid fa-university text-slate-600 text-xl"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white">Biomedical Sciences</h3>
